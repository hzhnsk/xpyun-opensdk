...
import (
	...
	"github.com/hzhnsk/xpyun-opensdk/formatter"
	"github.com/hzhnsk/xpyun-opensdk/model"
	"github.com/hzhnsk/xpyun-opensdk/service"
	"github.com/hzhnsk/xpyun-opensdk/util"
)
...
func PrintComplexReceipt() {
	...
	*/
	...
	msg := fmt.Sprintf("response result: %+v", string(reslutJson))
	fmt.Println(msg)
}
